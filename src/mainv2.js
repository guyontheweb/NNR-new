      ...
      <div class="container">
        <div class="columns">
          <div class="column controls">
            <div>
              <h2 class="owt-title">NetscapeNavigatorRevival - Home</h2>
              ...
              <div class="form-group">
                ...
                <div class="dropdown full-width browser">
                  ...
                  <select id="browser-menu" class="menu">
                    ${this.emuOptions.map((emu, i) => html`
                      ${emu.hidden ? html`` : html`
                      <option class="menu-item" style="">
...
<style>body {background-color: #3F6EA3;}</style>
<br></br>
<center><div class="window" style="width: 50%">
  <div class="title-bar">
    <div class="title-bar-text">Instance.exe (null)</div>
  </div>
  <div class="window-body">
<p> Here We have some buttons you can click on to go to different websites! You can also advertise us by copying the code below and putting it on your website!</p>
<textarea><a href="http://netscapenavigatorrevival.neocities.org"><img src="http://netscapenavigatorrevival.neocities.org/nsnow.jpg" width="88" height="31"></textarea><br>
<a href="http://arandomsite.neocities.org"><img src="https://arandomsite.neocities.org/IMG/install88x31Button.png"></a> <a href="http://neocities.org"><img src="neocitiesnow_retro.png" width="88" height="31"></a> <a href="http://netscapenavigatorrevival.neocities.org"><img src="http://netscapenavigatorrevival.neocities.org/nsnow.jpg" width="88" height="31"> <a href="https://wac.neocities.org/"><img src="https://i.imgur.com/XTmRsxw.jpg"></a> <a href="http://novetusfun.ddns.net/Geocities_1995/gpagetest.php?id=3"><img src="https://i.ibb.co/0qsmMTk/Idamcn.png"></a><br>Page Managed by <a href="http://wwwrp.neocities.org">WWWRP</a><br><a href="/other"><button>Other Stuff..</button></a>
  </div>
  <div class="status-bar">
    <p class="status-bar-field">Press F1 for help</p>
    <p class="status-bar-field">Slide 2</p>
    <p class="status-bar-field">CPU Usage: 11%</p>
  </div>
</div>
                ${!!this.replayTs ? html`
                <details>
