...
<details>
<summary>Click here for browser settings!</summary>
    ...
    <p class="status-bar-field">Netscape Navigator Revival: Reimagined.</p>
    <p class="status-bar-field">Based off of <a href="https://oldweb.today">Oldweb.today</a> source.</p>
    <p class="status-bar-field">I haven't slept in 3 days :D</p>
  </div>
  					  </div>
</div>
        </div>
